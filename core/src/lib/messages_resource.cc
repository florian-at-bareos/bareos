                                          ...
                                          const std::string& where)
{
  ...
  if (pos != dest_chain_.rend()) {
    ...
    Dmsg4(850, "add to existing d={} msgtype={} destcode={} where={}\n", d,
                                     ...
                                     const std::string& timestamp_format)
{
  ...
  Dmsg6(850,
        "add new d={} msgtype={} destcode={} where={} mailcmd={} "
        "timestampformat={}\n",
